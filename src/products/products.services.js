...
const patchProduct = (req, res)=> {
    ...
    productsControllers.modifyProduct(id, {name, category, price, isAvailable})
    .then((response)=> {
        if(response[0]){
            res.status(200).json({
...
module.exports = { showAllProducts, addProduct, searchProductById, patchProduct, putProduct, destroyProduct }